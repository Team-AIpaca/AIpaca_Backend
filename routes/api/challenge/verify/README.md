...
API to output a list of all achievements a user has earned.

# Request
| HTTP Method | Request URL |
|-------------|-------------|
| `POST` | http://{address}:{port}/api/challenge/verify |
...
|------------|----------|------|-------|
| `username` | Yes | `String` | The name of the user whose achievement list you want to view |
...
| `message` | `String` | Return `User achievements retrieved successfully.` message on successful request processing |
